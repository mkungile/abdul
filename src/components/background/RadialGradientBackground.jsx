...
//           { color: "rgba(141, 255, 105, 0.45)", stop: "25%" },
//           { color: "rgba(141, 255, 105, 0.5)", stop: "40%" },
//           { color: "rgba(141, 255, 105, 0.45)", stop: "60%" },
//           { color: "rgba(141, 255, 105, 0.25)", stop: "80%" },
//         ],
//         blur: "0px",
//         opacity: 0.5,
//       },
...
//         size: "w-[720px] h-[700px]",
//         colors: [
//           { color: "rgba(141, 255, 105, 0.25)", stop: "0%" },
//           { color: "rgba(141, 255, 105, 0.45)", stop: "30%" },
//           { color: "rgba(141, 255, 105, 0.5)", stop: "45%" },
//           { color: "rgba(141, 255, 105, 0.45)", stop: "65%" },
//           { color: "rgba(141, 255, 105, 0.25)", stop: "85%" },
//         ],
//         blur: "0px",
//         opacity: 0.5,
//       },

...
const Skills = () => {
  ...
  const SkillCategories = {
    "Frontend Developer": [
      ...
      skills.find(s => s.name === "Taillwind CSS"),
  ...
  const getLevelColor = (level) => {
    const colors = {
      'Expert': "text-[#EDFF69] bg-[#80ff69]/20 border-[#80ff69]/30",
      'Advanced': "text-[#EDFF69] bg-[#80ff69]/20 border-[#0000]/30",
      'Intermediate': "text-[#EDFF69] bg-[#80ff69]/20 border-[#80ff69]/30",
    };
  ...
  return <section id="skills" className="relative py-20 bg-black overflow-hidden">
    ...
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute top-1/4 left-0 w-96 h-96 bg-primary rounded-full blur-3xl opacity-10" />
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              A Comprehensive overview of the technical skills
            </p>
  ...
  ([category, categorySkills], categoryIndex) => (
    <FadeIn key={category} delay={categoryIndex = 100}>
      <div className="relative bg-white/5 border border-white/10 ounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group">
        <div className="flex items-center gap-3 mb-6 gb-4 border-b border-white/10">
    ...
    return (
      <div key={skill.id} className="space-y-2">
        ...
        <div className="relative h-1.5 bg-white/5 rounded-full overflow-hidden">
          <div
            className="absolute top-0 left-0 h-full bg-linear-to-r from-primary/10 to-primary/80 rounded-full transition-all duration-1000 ease-auto"

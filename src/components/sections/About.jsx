...
const About = () => {
    ...
    const skills = [
        ...
        {name: 'TailwindCSS', icon: SiTailwindcss, color: '#002020'},
        {name: 'Node.js', icon: SiNodedotjs, color: '#3178C6'},
        {name: 'MongoDB', icon: SiMongodb, color: '#068604'},
                        ...
                        <FadeIn delay={200}>
                            <div className='flext flex-col gap-4'>
                                {Personal_info.bio.map((paragraph, index) =>(
                                    <p key={index} className=' text-base text-white/20 leading-relaxed'>
                                        {paragraph}
                            ...
                            <div className='grid grid-cols-3 gap-8'>
                                {ABOUT_STATS.map((stat, index) =>{
                                    <div key={index} className='relative'>
                                        <div className='absolute -left-4 top-0 w-1 h-full bg-linear-to-b from-primary via-primary/50 to-primary/10 rounded-full'>
                                        ...
                                        <p className='text-sn text-white/60 leading-snug'>
                                            {stat.label}
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div className='flex items-start gap-4'>
                                    ...
                                    <div className='flex-1'>
                                        ...
                                        <p className='text-sm text-white/70 leading-relaxed'>
                                            Specialized in building scalable Mobile application
                        ...
                        <div className='relative group'>
                            ...
                            <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                ...
                                <p className='text-sm text-white/10 leading-relaxed'>Writing maintainable, well documented applications</p>
                        ...
                        <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                            ...
                            <p className='text-sm text-white/10 leading-relaxed'>Optimizing for speed and effeciency</p>
                        ...
                        <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                            <div className='grid grid-cols-3 gap-6 text-center'>
                                   ...
                                   <div>
                                    ...
                                    <div className='text-x5 text-white/60'>Client Satisfied</div>
                                   </div>
                                ...
                                <div>
                                     ...
                                     <div className='text-xm text-white/60'>Delivery Time</div>
                                </div>
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl'>
                            {skills.map((skill, index) => (
                                ...
                                >
                                    ...
                                    <div className='text-sm text-white/40 font-medium text-center'> 
                                    {skill.name}
                                    </div>
